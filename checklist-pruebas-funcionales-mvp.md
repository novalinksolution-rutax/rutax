...
11. Todo el trabajo de esta sesión (y de sesiones anteriores de Fase B/C) está **sin commitear** — `git status` muestra ~80 archivos modificados/nuevos sobre el commit `373f1e6`. Se recomienda revisar y commitear en bloques lógicos antes de avanzar a frontend/UX para no perder el trabajo y facilitar el code review.
