...
15 objetos. Para cada uno: **una representación canónica, variantes por densidad derivadas de ella, variantes por rol, y un vocabulario único**. Ningún bloque de trabajo puede redefinir un objeto: se derivan variantes y se declaran.
