/**
 * Torre de control — estructura completa + datos dummy.
 * =====================================================================
 *
 * PROPÓSITO: entregar la estructura de información y un dataset realista
 * COMPLETO, sin ninguna decisión visual, para que la interfaz se diseñe aparte.
 *
 * Este archivo NO opina sobre colores, tipografía, espaciado ni layout. Solo
 * define QUÉ información existe, cómo se relaciona y en qué estados puede
 * estar. La capa visual es libre.
 *
 * Contexto de los datos: sábado 25 de julio de 2026, 09:14, hora de Santiago
 * (UTC-04:00 en invierno). Courier de demo con 412 pedidos en el día.
 *
 * Todos los montos en CLP (enteros, sin decimales).
 */
