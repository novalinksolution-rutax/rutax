...
VISTA: `/conductor/liquidaciones` — Mis liquidaciones (PWA)
DISPOSITIVO: móvil vertical 9:19
CONTEXTO: El conductor ve sus liquidaciones (cuánto le toca y por qué) como tarjetas verticales, con el monto en tipografía grande y descarga del PDF. No ve cobros al seller.
...
- Encabezado: enlace gris "← Manifiesto" seguido del título "Mis liquidaciones" (bold ~20px).
- Lista vertical de **tarjetas de liquidación**, una por período: línea superior con el rango de fechas (mono) y un badge de estado a la derecha (gris "Borrador", azul "Emitida", verde "Pagada"); línea media con "86 entregas" en gris a la izquierda y el **monto muy grande** en CLP a la derecha ($ 430.000); abajo, un botón ancho de descarga "Descargar PDF" o, si no hay, la nota gris "PDF disponible cuando la liquidación sea emitida."
DATOS DE EJEMPLO (ilustrativos): conductor "Diego Soto"; períodos 01/06/2026 – 15/06/2026 ($ 430.000, 86 entregas, Pagada) y 16/06/2026 – 30/06/2026 ($ 360.000, 72 entregas, Emitida).
NOTA DE CONVERGENCIA: tarjetas táctiles con monto grande en cifras tabulares; badges de liquidación del set (gris/azul/verde). Cabecera del conductor idéntica a las otras vistas de la PWA.
