...
VISTA: `/onboarding/folios` — Folios CAF
DISPOSITIVO: escritorio 16:10
CONTEXTO: Carga y estado de los folios CAF (rangos autorizados por el SII para timbrar documentos). Muestra el rango vigente y cuántos folios quedan.
...
- Título "Folios CAF" (semibold ~24px) y subtítulo gris: "Los folios autorizan a tu courier a timbrar documentos tributarios ante el SII."
- Tarjeta de estado actual: "CAF vigente — Folios 1001 a 1100", con una **barra de progreso** del consumo y texto "Quedan 58 de 100 folios"; si quedaran pocos, un aviso ámbar.
- Tarjeta de carga: campo para subir el archivo CAF (.xml) con nota explicativa; botón primario navy "Subir CAF".
- (Opcional) pequeña tabla/historial de CAF cargados con rango y estado (badge verde "Vigente", gris "Agotado").
DATOS DE EJEMPLO (ilustrativos): rango folios 1001–1100; quedan 58; empresa "Flex Couriers SpA".
NOTA DE CONVERGENCIA: barra de progreso navy, badges de estado del set, montos/números en cifras tabulares. Shell idéntico al backoffice.
