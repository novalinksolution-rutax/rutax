...
VISTA: `/manifiestos` — Lista de manifiestos
DISPOSITIVO: escritorio 16:10
CONTEXTO: Lista de los manifiestos (rutas del día por conductor) del courier, con filtros y acceso a crear uno nuevo.
...
- Encabezado: título "Manifiestos" (bold ~24px) a la izquierda; botón primario navy con ícono "+" "Nuevo manifiesto" a la derecha.
- Barra de filtros: selector "Estado" y campo de fecha.
- Tabla dentro de tarjeta blanca (densidad cómoda), con conteo gris "8 manifiestos" arriba. Columnas: **Estado** (badge: ámbar "Borrador", azul "Confirmado", verde "Completado", gris "Cancelado"), **Nombre** (enlace en negrita), **Fecha**, **Conductor**.
DATOS DE EJEMPLO (ilustrativos): manifiestos "Ruta Oriente — 14/06", "Ruta Sur — 14/06", "Ruta Poniente — 13/06"; conductores "Diego Soto", "Francisca Vera"; fechas 14/06/2026.
NOTA DE CONVERGENCIA: misma tabla y mismos badges de estado de manifiesto del set. Shell idéntico al resto del backoffice.
