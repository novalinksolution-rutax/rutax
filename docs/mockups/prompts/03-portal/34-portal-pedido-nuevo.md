...
VISTA: `/portal/pedidos/nuevo` — Solicitar envío same-day (seller)
DISPOSITIVO: escritorio 16:10
CONTEXTO: Formulario del seller para pedir una entrega same-day ad-hoc. El envío queda pendiente de asignación hasta que el courier lo asigne.
ESTRUCTURA (portal del seller): cabecera superior blanca liviana con "Portal del seller" + nav horizontal + "Cerrar sesión". Contenido en una columna centrada (~640px) con aire, sobre gris claro.
LAYOUT del contenido:
- Enlace gris "← Mis pedidos".
- Título "Solicitar envío same-day" (semibold ~24px) y subtítulo gris: "El envío quedará en estado *pendiente de asignación* y el courier lo asignará a un conductor durante el día."
- Tarjeta blanca con formulario en una columna (inputs con etiqueta arriba): "Nombre del destinatario", "Dirección de entrega", selector "Comuna" (catálogo RM, ej. Maipú/Las Condes/Ñuñoa), "Teléfono de contacto", área "Instrucciones de entrega".
- Botón primario navy "Solicitar envío" y botón secundario "Cancelar".
DATOS DE EJEMPLO (ilustrativos): destinatario "Camilo Díaz"; dirección "Av. Concha y Toro 1234"; comuna "Puente Alto"; teléfono +56 9 8765 4321.
NOTA DE CONVERGENCIA: formulario de una columna con inputs del set y selector de comuna estilo shadcn; densidad relajada del portal. Header del portal idéntico al resto.
