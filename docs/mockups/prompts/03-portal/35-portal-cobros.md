...
VISTA: `/portal/cobros` — Estado de cuenta del seller
DISPOSITIVO: escritorio 16:10
CONTEXTO: El seller ve sus períodos de cobro y facturas. Solo lectura, transparente: cuánto y por qué. No ve montos de tarifas internas ni datos de conductores.
ESTRUCTURA (portal del seller): cabecera superior blanca liviana con "Portal del seller" + nav horizontal ("Inicio", "Mis pedidos", "Estado de cuenta" activa, "Incidencias") + "Cerrar sesión". Contenido centrado (~960px) con aire, sobre gris claro.
LAYOUT del contenido:
- Título "Estado de cuenta" (semibold ~24px) y subtítulo gris "Tus períodos de cobro y facturas. Solo lectura."
- Chips de resumen: "Abiertos: 1" (azul), "Facturados: 6" (verde).
- Tabla espaciada (densidad relajada) en tarjeta. Columnas: **Período** (rango de fechas, enlace mono), **Estado** (badge: azul "Abierto", verde "Facturado — Folio 1042"), **Líneas** (derecha), **Monto total** (derecha, negrita CLP), **Factura** (badge SII con ícono: verde-check "Aceptado por SII", o "Sin factura" gris), **Pago** (badge: ámbar "Por cobrar", verde "Pagado").
DATOS DE EJEMPLO (ilustrativos): períodos 01/06/2026 – 15/06/2026 ($ 1.240.500, Facturado, Pagado) y 16/06/2026 – 30/06/2026 ($ 410.000, Abierto).
NOTA DE CONVERGENCIA: badges de período/SII/cobro y montos CLP del set; densidad relajada del portal. Header del portal idéntico al resto.
