...
VISTA: `/registro` — Crea tu cuenta de courier (alta de la empresa)
DISPOSITIVO: escritorio, formulario centrado (16:10)
CONTEXTO: Auto-servicio público donde el dueño da de alta su empresa de courier en un solo paso. No se pide contraseña aquí: se enviará un correo para activarla.
LAYOUT (de arriba hacia abajo):
- Fondo gris muy claro, sin navegación. Tarjeta blanca centrada, más ancha (~640px), borde 1px, sombra mínima.
- Título "Crea tu cuenta de courier" (~24px) y subtítulo gris: "Registra tu empresa en un solo paso. Te enviaremos un correo para activar tu cuenta y crear tu contraseña."
- Formulario en UNA columna, dividido en dos bloques con subtítulo y un ícono de línea a la izquierda:
  - Bloque "Tu empresa" (ícono de edificio): campo "Nombre de fantasía" (placeholder "Ej: Despachos Rápidos SpA"); campo "Razón social"; campo "RUT de la empresa" con placeholder de formato chileno `12.345.678-9` y texto de ayuda de formato debajo.
  - Bloque "Tú, como dueño" (ícono de persona): campo "Nombre completo" (placeholder "Ej: María Pérez Soto"); campo "Correo electrónico" (placeholder "tu@empresa.cl").
- Botón primario navy "Crear mi cuenta", con una línea gris debajo: "Te enviaremos un correo a tu correo para que crees tu contraseña y actives tu cuenta."
DATOS DE EJEMPLO (ilustrativos): "Flex Couriers SpA"; razón social "Flex Couriers Sociedad por Acciones"; RUT 76.543.210-K; dueña "Camila Rojas"; correo `camila.rojas@flexcouriers.cl`.
NOTA DE CONVERGENCIA: misma tarjeta y mismos inputs (etiqueta arriba, ayuda gris debajo) que el resto del set; formulario de una sola columna, calmado y sobrio. Mantén EXACTAMENTE tipografía y paleta del set.
